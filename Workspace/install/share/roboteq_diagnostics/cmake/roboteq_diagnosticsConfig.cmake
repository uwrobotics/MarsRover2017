...
if("FALSE" STREQUAL "TRUE")
  set(roboteq_diagnostics_SOURCE_PREFIX /home/ivy/marsrover/MarsRover2017/Workspace/src/roboteq-indigo-devel/roboteq_diagnostics)
  set(roboteq_diagnostics_DEVEL_PREFIX /home/ivy/marsrover/MarsRover2017/Workspace/devel)
  ...
  set(roboteq_diagnostics_INSTALL_PREFIX /home/ivy/marsrover/MarsRover2017/Workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ivy/marsrover/MarsRover2017/Workspace/install/${idir}'.  Ask the maintainer 'Mike Purvis <mpurvis@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${roboteq_diagnostics_dep}_FOUND)
      find_package(${roboteq_diagnostics_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${roboteq_diagnostics_dep} REQUIRED ${depend_list})
  endif()
