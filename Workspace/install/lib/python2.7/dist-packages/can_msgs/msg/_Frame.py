...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_I4B.pack(_x.id, _x.is_rtr, _x.is_extended, _x.is_error, _x.dlc))
      _x = self.data
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.is_rtr, _x.is_extended, _x.is_error, _x.dlc,) = _struct_I4B.unpack(str[start:end])
