...
void frameFormerHelper()
{
        ...
        populateFrame(&limbsCANFrame, outputPWM[2], outputPWM[3]);
        limbsCANFrame.id = ID_LIMBS_FRAME;
        limbsCANFrame.dlc = 8;
        limbsCANFrame.is_error = 0;
        limbsCANFrame.is_rtr = 0;
        limbsCANFrame.is_extended = 0;

        populateFrame(&othersCANFrame, outputPWM[4], outputPWM[5]);
        othersCANFrame.id = ID_OTHERS_FRAME;
        othersCANFrame.dlc = 8;
        othersCANFrame.is_error = 0;
        othersCANFrame.is_rtr = 0;
        othersCANFrame.is_extended = 0;
}